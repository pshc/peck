...
/// Paired with an ID (generated by the editor thread)
/// Two snapshots with the same ID *must* have the same `text`
/// However, any given `text` can have unlimited associated IDs
#[derive(Debug)]
pub struct Snapshot {
    pub id: String,
    pub text: String,
